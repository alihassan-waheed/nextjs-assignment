  ...
  return (
    <html lang="en">
      ...
      <div className="flex flex-no-wrap">
            {/* Sidebar starts */}
            <div className="w-64 absolute sm:relative bg-slate-50 shadow md:h-full flex-col justify-between hidden sm:flex">
                <div className="px-8">
                    <div className="w-full flex items-center">
                        <img src='assets/img/logo.png' />
                    </div>
                    <ul className="mt-12">
                        <li className="flex w-full justify-between text-slate-500 hover:text-slate-800 cursor-pointer items-center mb-6">
                          <Link href={"/"}>
                            ...
                            <div className="py-1 px-3 bg-gray-200 rounded text-slate-500 flex items-center justify-center text-xs">5</div>
                        </li>
                        <li className="flex w-full justify-between text-slate-500 hover:text-slate-800 cursor-pointer items-center mb-6">
                          <Link href={"/products"}>
                            <div className="flex items-center">
                            ...
                            <div className="py-1 px-3 bg-gray-200 rounded text-slate-500 flex items-center justify-center text-xs">8</div>
                        </li>
                        <li className="flex w-full justify-between text-slate-500 hover:text-slate-800 cursor-pointer items-center mb-6">
                          <Link href={"/invoices"}>
                            <div className="flex items-center">
                            ...
                            <div className="py-1 px-3 bg-gray-200 rounded text-slate-500 flex items-center justify-center text-xs">25</div>
                        </li>
                        <li className="flex w-full justify-between text-slate-500 hover:text-slate-800 cursor-pointer items-center mb-6">
                          <Link href={"/inventory"}>
                            <div className="flex items-center">
                    ...
                    <div className="flex justify-center mt-48 mb-4 w-full">
                        <div className="relative ">
                            <div className="text-slate-500 absolute ml-4 inset-0 m-auto w-4 h-4">
                            ...
                            <input className=" bg-gray-200 focus:outline-none rounded w-full text-sm text-slate-500 bg-gray-100 pl-10 py-2" type="text" placeholder="Search" />
                        </div>
                    </div>
                </div>
                <div className="px-8 border-t border-slate-400">
                    <ul className="w-full flex items-center justify-between bg-slate-50">
            ...
            <div className="w-64 z-40 absolute bg-gray-800 shadow md:h-full flex-col justify-between sm:hidden  transition duration-150 ease-in-out" id="mobile-nav">
                ...
                <div className="px-8">
                    ...
                    <ul className="mt-12">
                        <li className="flex w-full justify-between text-slate-300 hover:text-slate-500 cursor-pointer items-center mb-6">
                          <Link href={"/"}>
                            <div className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-grid" width={18} height={18} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" />
                        ...
                        <li className="flex w-full justify-between text-gray-600 hover:text-slate-500 cursor-pointer items-center mb-6">
                          <Link href={"/products"}>
                            <div className="flex items-center">
                                <svg xmlns="http://www.w3.org/2000/svg" className="icon icon-tabler icon-tabler-puzzle" width={18} height={18} viewBox="0 0 24 24" strokeWidth="1.5" stroke="currentColor" fill="none" strokeLinecap="round" strokeLinejoin="round">
                                    <path stroke="none" d="M0 0h24v24H0z" />
